...
import 'package:fluttermultistoreflutter/utils/ps_progress_dialog.dart';
                                    ...
                                    child: Container(
                                      ...
                                      decoration: const BoxDecoration(
                                          image: DecorationImage(
                                              fit: BoxFit.cover,
                                              image: AssetImage(
                                                  'assets/images/industria_logo.png'))),
                                    ),
                                  ),
                                  //const SizedBox(
                                  //height: 7,
                ...
                if (await Utils.checkInternetConnectivity()) {
                  ...
                  if (_apiStatus.data != null) {
                    ...
                    if (widget.onProfileSelected != null) {
                      ...
                      //AQUI CAMBIE LA RUTA AL REGISTRAR//
                      //Navigator.pushReplacementNamed(
                      //context, RoutePaths.shopDashboard);
                    }
                  } else {
                    PsProgressDialog.dismissDialog();
...
//Text('O PUEDES', style: Theme.of(context).textTheme.subtitle1);
// return Row(
